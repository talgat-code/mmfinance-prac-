          ...
          <div className="grid overflow-hidden rounded-[1.75rem] bg-primary text-white shadow-[0_34px_110px_rgb(7_20_38_/_0.24)] ring-1 ring-primary/10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="relative overflow-hidden p-6 sm:p-8 lg:p-10">
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-3">
                <a
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-bold text-primary transition hover:-translate-y-0.5 hover:bg-[#b88a16] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
                  href="#contacts"
                >
                  {t('promo.applyButton')}

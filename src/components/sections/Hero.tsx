            ...
            <div className="relative rounded-[1.5rem] border border-white/10 bg-white/8 p-6 backdrop-blur">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                <a
                  ...
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-bold text-primary transition hover:bg-[#b88a16]"
                  href={`tel:${phoneHref}`}
                >

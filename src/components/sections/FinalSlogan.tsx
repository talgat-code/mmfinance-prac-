      ...
      <div className="mx-auto max-w-6xl lg:px-8">
        <SectionReveal>
          <div className="relative overflow-hidden rounded-[1.75rem] bg-primary px-6 py-12 text-center text-white shadow-[0_32px_100px_rgb(15_23_42_/_0.22)] sm:px-10 sm:py-16">
            <div className="absolute inset-0 bg-[linear-gradient(135deg,_rgb(34_197_94_/_0.22),_transparent_36%),linear-gradient(180deg,_rgb(255_255_255_/_0.08),_transparent)]" />
